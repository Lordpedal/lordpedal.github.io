...
{: .full}
[TubeSync](https://github.com/meeb/tubesync){: .btn .btn--warning .btn--small}{:target="_blank"} es un `PVR` (**Personal Video Recorder**) diseñado inicialmente para `Youtube`, aunque según he leido en su código pensado para en un futuro ampliarlo a más plataformas.
