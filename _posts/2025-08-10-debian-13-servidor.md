...
La opción Debian Blend agrega paquetes preconfigurados, [ampliar información](https://www.debian.org/blends/index.es.html){: .btn .btn--warning .btn--small}{:target="_blank"}
{: .notice--info}
...
Esta opción no viene habilitada por defecto en Debian 13 y para ello tendremos que habilitarla, creamos el servicio para [Systemd](https://es.wikipedia.org/wiki/Systemd){: .btn .btn--inverse .btn--small}{:target="_blank"}:
